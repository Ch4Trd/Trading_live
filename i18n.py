...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "help": {
        "fr": (
            ...
            "🔹 /result           – Résultats économiques du jour (Actual vs Forecast)\n🔹 /daily            – Brief auto 07:00 + résultats fin de journée (/daily on|off)\n"
        ...
        "en": (
            ...
            "🔹 /result           – Today's economic results (Actual vs Forecast)\n🔹 /daily            – Auto brief 07:00 + end-of-day results (/daily on|off)\n"
        ...
        "es": (
            ...
            "🔹 /result           – Resultados económicos del día (Actual vs Previsión)\n🔹 /daily            – Resumen auto 07:00 + resultados fin del día (/daily on|off)\n"
        ...
        "ar": (
            ...
            "🔹 /result           – نتائج اليوم الاقتصادية (الفعلي مقابل التوقع)\n🔹 /daily            – ملخّص تلقائي 07:00 + نتائج نهاية اليوم (/daily on|off)\n"
